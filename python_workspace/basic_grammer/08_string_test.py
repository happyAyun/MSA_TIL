hello=" Hello Python " # 문자열 배열 : 0 ~ len() **

print(hello[2:3]) # index : 2부터 ~ (3-1) 까지
print(hello[-3:-1]) # index -1은 맨 마지막 인덱스를 가리키고 왼쪽방향으로 +1을 함.(첫번째 인덱스는 '-배열의 크기')
print(len(hello)) # 문자열 길이 : 인덱스 크기와 같다.
print("문자열 '안녕하세요' 길이는 {0} 입니다." .format(len("안녕하세요"))) # 문자열 형식 지정 IndexError 주의

print(hello.upper())
print(hello.lower())
print(hello.strip()) # 공백 제거
...
print("'l' 문자열 검색 ",hello.rfind("l"))  # 검색한 문자열 last index return : 오른쪽부터
