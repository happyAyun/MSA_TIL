...
let p = new Person("심아윤",25);
p.print();

// JS의 get,set의 사용법
p.birthYear=1997; // p.birthYear(1997) - not a function error
console.log(`${p.birthYear}`); //p.birthYear() X
...
let s = new Student("심아윤",25,"컴퓨터정보공학부").print();
let s2 = new Student("심아윤",25,"컴퓨터정보공학부");
s2.print();

// 3. JSON(JavaScript Object Notation) - object를 표현해주는 표현법.
// 데이터를 가지는 객체. 
// 데이터를 주고 받는 형태로 데이터의 교환을 위해 사용됨.
let e = {person : {name:'심아윤', age:25}, department:'연구소', array:[1,2,3,4,5], female:'true'}; // object 방식
//object, string, array, true/false/null
console.log(e);
let array = [{name:"심아윤",age:28}, 1, [1, 2, 3, 4], "name", "false", "null"]; // array 방식
console.log(array[2]);